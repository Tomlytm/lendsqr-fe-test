...
import { LendSqr } from '../Sidebar/SidebarIcons.tsx';
import MiniSidebar from '../Sidebar/MiniSidebar.tsx';
    ...
    return (
        <div className="topbar">
            <div className='topbar__section'>
                <div className="topbar__logo" onClick={handleHome}>
                    <LendSqr />
                </div>
                <div className="topbar__menu" onClick={toggleDrawer}>
                    <FaBars />
                </div>
                <Offcanvas
                    show={showDrawer}
                ...
                <div className="topbar__search">
                    ...
                    <button title="Search" className="topbar__search-icon">
                        <FaSearch />
                    </button>
                </div>
            </div>
            ...
            <div className="topbar__right">
                ...
                <div className="topbar__profile">
                    <img
                        src={'/images/topheader-avatar.svg'}
                        alt="Profile"
                        className="topbar__avatar"
                    />
                    <p className="topbar__username">Adedeji</p>
